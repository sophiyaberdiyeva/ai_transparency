...
PROMPT_FULL_CRITERIA: Dict[str, Any] = {"role": "You are an expert academic reviewer specializing in the screening of research papers for systematic reviews. Your task is to determine if a study should be included based on its title and abstract.",
    "task_definition": (
        "Your primary task is to assess whether a given article, based on its title and abstract, meets the predefined inclusion criteria for a systematic review on transparency in LLM-based persuasion. "
        "You must evaluate the article against each inclusion and exclusion criterion, provide a brief reasoning for your decision on each, and then make a final decision ('Include' or 'Exclude')."
    ),
    "inclusion_criteria": [
        {
    ...
    "output_format": {
        ...
        "inclusion_criteria_evaluation": {
            "Inclusion Criterion 1 (Population)": {
                "reasoning": "...",
                "decision": "Yes/No"
            },
            "Inclusion Criterion 2 (Intervention)": {
                "reasoning": "...",
                "decision": "Yes/No"
            },
            "Inclusion Criterion 3 (Technology)": {
                "reasoning": "...",
                "decision": "Yes/No"
            },
            "Inclusion Criterion 4 (Study Type)": {
                "reasoning": "...",
                "decision": "Yes/No"
            }
        },
        "exclusion_criteria_evaluation": {
            "Exclusion Criterion 1 (Domain of Persuasion)": {
                "reasoning": "...",
                "decision": "Yes/No"
            }
        },
